        ...
        <div class="row ms-0 me-0 w-100">
            <div class="col-md-12 ps-1 pe-1 border-primary">
                <div class="card border-primary mb-2">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end border">
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ route('postsManage.edit', ['id'=>$post->id]) }}"><i
                    ...
                    <div class="card-body">
                        {{-- <?php $newfiles = App\Models\InfoFile::where('idPost', $post->id)->get(); ?> --}}
                        <div class="tai-lieu row">
                            @each('layouts.admin.file', $files, 'file')
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-danger" type="button"
                            href="{{ route('postsManage.delete', ['id'=>$post->id]) }}"><i class="fa fa-trash me-2"></i>
                            Xóa</a>
                    </div>
                </div>
            </div>
