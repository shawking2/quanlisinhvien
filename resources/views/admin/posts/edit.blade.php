                ...
                <div class="col-md-8 ps-1 pe-1">
                    <div class="card border-primary mb-2">
                        <div class="card-header bg-light">
                            <p class="m-0">
                                <a href="{{route('postsManage.index')}}">Danh sách Bài viết</a> /
                                <a href="{{route('postsManage.show', $post->id)}}">{{$post->title}}</a> /
                            </p>
                ...
                <div class="col-md-4 ps-1 pe-1">
                    <div class="mb-2 card border-primary mb-2">
                        ...
                        <div class="mb-3 @error('imgfile') is-invalid border-danger @enderror">
                            ...
                            <a href="/storage/{{$idinfoFile->name}}">{{$idinfoFile->name}}</a>
                        </div>
                        ...
                        <div class="modal-dialog mt-5 pt-5" role="document">
                            <div class="modal-content border-danger">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" id="deletePost" name="delete" class="btn btn-danger"><i
